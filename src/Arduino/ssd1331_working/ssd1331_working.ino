...
void lcdTestPattern(void)
{
  ...
  for(i=0;i<64;i++)
  {
    for(j=0;j<96;j++)
    {
      if(i>55){display.writeData(uint8_t(WHITE>>8));display.writeData(uint8_t(WHITE));}
      else if(i>47){display.writeData(uint8_t(BLUE>>8));display.writeData(uint8_t(BLUE));}
      else if(i>39){display.writeData(uint8_t(GREEN>>8));display.writeData(uint8_t(GREEN));}
      else if(i>31){display.writeData(uint8_t(CYAN>>8));display.writeData(uint8_t(CYAN));}
      else if(i>23){display.writeData(uint8_t(RED>>8));display.writeData(uint8_t(RED));}
      else if(i>15){display.writeData(uint8_t(MAGENTA>>8));display.writeData(uint8_t(MAGENTA));}
      else if(i>7){display.writeData(uint8_t(YELLOW>>8));display.writeData(uint8_t(YELLOW));}
      else {display.writeData(uint8_t(BLACK>>8));display.writeData(uint8_t(BLACK));}
    }
  }
}
